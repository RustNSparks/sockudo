...
impl sockudo::adapter::ConnectionManager for FailingAdapter {
    ...
    async fn get_namespace(&mut self, _app_id: &str) -> Option<Arc<sockudo::namespace::Namespace>> { None }
    async fn add_socket(&mut self, _socket_id: sockudo::websocket::SocketId, _socket: fastwebsockets::WebSocketWrite<tokio::io::WriteHalf<hyper_util::rt::TokioIo<hyper::upgrade::Upgraded>>>, _app_id: &str, _app_manager: &Arc<dyn sockudo::app::manager::AppManager + Send + Sync>) -> sockudo::error::Result<()> { Ok(()) }
    async fn get_connection(&mut self, _socket_id: &sockudo::websocket::SocketId, _app_id: &str) -> Option<sockudo::websocket::WebSocketRef> { None }
    async fn remove_connection(&mut self, _socket_id: &sockudo::websocket::SocketId, _app_id: &str) -> sockudo::error::Result<()> { Ok(()) }
    async fn send_message(&mut self, _app_id: &str, _socket_id: &sockudo::websocket::SocketId, _message: sockudo::protocol::messages::PusherMessage) -> sockudo::error::Result<()> { Ok(()) }
    async fn send(&mut self, _channel: &str, _message: sockudo::protocol::messages::PusherMessage, _except: Option<&sockudo::websocket::SocketId>, _app_id: &str) -> sockudo::error::Result<()> { Ok(()) }
    async fn get_channel_members(&mut self, _app_id: &str, _channel: &str) -> sockudo::error::Result<std::collections::HashMap<String, sockudo::channel::PresenceMemberInfo>> { Ok(std::collections::HashMap::new()) }
    async fn get_channel_sockets(&mut self, _app_id: &str, _channel: &str) -> sockudo::error::Result<dashmap::DashSet<sockudo::websocket::SocketId>> { Ok(dashmap::DashSet::new()) }
    async fn remove_channel(&mut self, _app_id: &str, _channel: &str) {}
    async fn is_in_channel(&mut self, _app_id: &str, _channel: &str, _socket_id: &sockudo::websocket::SocketId) -> sockudo::error::Result<bool> { Ok(false) }
    async fn get_user_sockets(&mut self, _user_id: &str, _app_id: &str) -> sockudo::error::Result<dashmap::DashSet<sockudo::websocket::WebSocketRef>> { Ok(dashmap::DashSet::new()) }
    async fn cleanup_connection(&mut self, _app_id: &str, _ws: sockudo::websocket::WebSocketRef) {}
    async fn terminate_connection(&mut self, _app_id: &str, _user_id: &str) -> sockudo::error::Result<()> { Ok(()) }
    async fn add_channel_to_sockets(&mut self, _app_id: &str, _channel: &str, _socket_id: &sockudo::websocket::SocketId) {}
    async fn get_channel_socket_count(&mut self, _app_id: &str, _channel: &str) -> usize { 0 }
    async fn add_to_channel(&mut self, _app_id: &str, _channel: &str, _socket_id: &sockudo::websocket::SocketId) -> sockudo::error::Result<bool> { Ok(false) }
    async fn remove_from_channel(&mut self, _app_id: &str, _channel: &str, _socket_id: &sockudo::websocket::SocketId) -> sockudo::error::Result<bool> { Ok(false) }
    async fn get_presence_member(&mut self, _app_id: &str, _channel: &str, _socket_id: &sockudo::websocket::SocketId) -> Option<sockudo::channel::PresenceMemberInfo> { None }
    async fn terminate_user_connections(&mut self, _app_id: &str, _user_id: &str) -> sockudo::error::Result<()> { Ok(()) }
    async fn add_user(&mut self, _ws: sockudo::websocket::WebSocketRef) -> sockudo::error::Result<()> { Ok(()) }
    async fn remove_user(&mut self, _ws: sockudo::websocket::WebSocketRef) -> sockudo::error::Result<()> { Ok(()) }
    async fn get_channels_with_socket_count(&mut self, _app_id: &str) -> sockudo::error::Result<dashmap::DashMap<String, usize>> { Ok(dashmap::DashMap::new()) }
    async fn get_sockets_count(&self, _app_id: &str) -> sockudo::error::Result<usize> { Ok(0) }
    async fn get_namespaces(&mut self) -> sockudo::error::Result<dashmap::DashMap<String, Arc<sockudo::namespace::Namespace>>> { Ok(dashmap::DashMap::new()) }
...
impl sockudo::cache::manager::CacheManager for FailingCacheManager {
    async fn has(&mut self, _key: &str) -> sockudo::error::Result<bool> { Ok(false) }
    async fn get(&mut self, _key: &str) -> sockudo::error::Result<Option<String>> { Ok(None) }
    async fn set(&mut self, _key: &str, _value: &str, _ttl_seconds: u64) -> sockudo::error::Result<()> { Ok(()) }
    async fn remove(&mut self, _key: &str) -> sockudo::error::Result<()> { Ok(()) }
    async fn disconnect(&mut self) -> sockudo::error::Result<()> { Ok(()) }
    async fn ttl(&mut self, _key: &str) -> sockudo::error::Result<Option<Duration>> { Ok(None) }
